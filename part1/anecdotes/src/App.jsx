...
const App = () => {
  ...
  const [highestVotedIndex, setHighestVotedIndex] = useState(null);
  ...
  const handleVote = () => {
    ...
    // Actualizar el índice de la anécdota con más votos
    const maxVotesIndex = copy.indexOf(Math.max(...copy));
    setHighestVotedIndex(maxVotesIndex);
  };
